...
MY OWN COMMENTS:
To edit papers, you need to add the year to _pages/publications.md, add the authors to _data/coauthors.yml, and edit _bibliography/papers.bib. To feature the paper on your about page, add selected=true in the bib file.
To add a photo for your paper, you need to drop it in assets/img/publication_preview
